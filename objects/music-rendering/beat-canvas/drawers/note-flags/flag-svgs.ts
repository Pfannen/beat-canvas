import { FlagNote } from "@/types/music-rendering/canvas/beat-canvas/drawers/note-flags";
import { SVGData } from "@/types/svg";

const flagSVGData: Partial<{ [K in FlagNote]: SVGData }> = {
  eighth: {
...
export const getFlagSVG = (type: FlagNote) => {
  return flagSVGData[type] || flagSVGData["eighth"]!;
};
