...
import { ScoreSegmentID } from '@/types/modify-score';
...
export const useEditMeasures = (
	...
	const createSelection = (
		...
		const newSelection: SegmentSelectionData = {
			...
			attributesAtX: getPartialMeasureAttributes(measure, xStart),
			noteIndex,
	...
	const isSegmentSelected = (measureIndex: number, x: number, y = 0) => {
