...
export const getSecondsBetweenXs = (
  ...
  const quarterNotesPerDuration = getQuarterNoteDuration(x2 - x1, beatNote);
...
export const getSecondsDurationOfNoteType = (
  ...
  const noteXDuration = getNoteDuration(noteType, beatNote, isDotted);

  return getSecondsBetweenXs(0, noteXDuration, metronome, beatNote);
};
