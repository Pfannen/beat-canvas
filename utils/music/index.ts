...
// NOTE: Duration should be the base duration of the note
// DO NOT included a note being dotted in the given duration
...
const noteToBeamCount: Partial<{ [K in NoteType]: number }> = {
  eighth: 1,
  sixteenth: 2,
  thirtysecond: 3,
};
